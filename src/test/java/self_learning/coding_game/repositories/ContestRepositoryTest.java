...
public class ContestRepositoryTest {
    ...
    void setup() {
        final List<Question> questionEasy = new ArrayList<Question>() {
            {
                add(new Question("1", "title1", Level.EASY, 10));
            }
        };
        ...
        final Map<String, Contest> contestMap = new HashMap<String, Contest>() {
            {
                put("1", new Contest("1", "contest1", questionEasy, Level.EASY, user1, ContestStatus.NOT_STARTED));
    ...
    public void saveContest() {
        ...
        Contest contest4 = new Contest("contest4", questionEasy, Level.EASY, user4, ContestStatus.NOT_STARTED);
        Contest expectedContest = new Contest("4", "contest4", questionEasy, Level.EASY, user4,
    ...
    public void findAllContestLevelWise_ShouldReturnEmptyList_GivenLevel() {
        ...
        int expectedCount = 0;
        // Act
        List<Contest> actualContests = contestRepository.findAllContestLevelWise(Level.HARD);
        // Assert
        Assertions.assertEquals(expectedCount, actualContests.size());
    }
