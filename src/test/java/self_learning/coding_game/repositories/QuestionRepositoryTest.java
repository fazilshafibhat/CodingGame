...
public class QuestionRepositoryTest {
    ...
    void setup() {
        final Map<String, Question> questionMap = new HashMap<String, Question>() {
            {
                put("1", new Question("1", "question1", Level.EASY, 10));
    ...
    public void saveQuestion() {
        // Arrange
        final Question question4 = new Question("title4", Level.EASY, 10);
        Question expectedQuestion = new Question("4", "title4", Level.EASY, 10);
        // Act
    ...
    public void findAllQuestionLevelWise_ShouldReturnQuestionList_GivenLevel() {
        ...
        final List<Question> expectedQuestions = new ArrayList<Question>() {
            {
                add(new Question("1", "title1", Level.EASY, 20));
            }
        };
        // Act
        List<Question> actualQuestions = questionRepository.findAllQuestionsLevelWise(Level.EASY);
        // Assert
    ...
    public void findAllQuestionLevelWise_ShouldReturnEmptyList_GivenLevel() {
        ...
        int expectedCount = 0;
        // Act
        List<Question> actualQuestions = questionRepository.findAllQuestionsLevelWise(Level.HARD);
        // Assert
        Assertions.assertEquals(expectedCount, actualQuestions.size());
    }
